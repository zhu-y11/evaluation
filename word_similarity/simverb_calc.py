...
def simVerbCalc(evaldata_file_path, emb_vocab, emb_vectors, lower_case):
  word_pairs, sims = readSimVerb(evaldata_file_path, lower_case)
...
def readSimVerb(data_file_path, lower_case):
